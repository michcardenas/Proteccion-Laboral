...
<template>
    <form @submit.prevent="emit('submit')" class="space-y-6">
        ...
        <div class="border-t border-brand-100 pt-6">
            <h3 class="text-sm font-semibold uppercase tracking-wider text-brand-500">Ubicación y sector</h3>
        ...
        <div class="border-t border-brand-100 pt-6">
            <h3 class="text-sm font-semibold uppercase tracking-wider text-brand-500">Contacto principal</h3>
            <div class="mt-3 grid grid-cols-1 gap-4 md:grid-cols-3">
